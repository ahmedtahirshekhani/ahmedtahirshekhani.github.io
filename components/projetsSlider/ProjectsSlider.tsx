  ...
  return (
    <div>
      <div className="flex flex-row">
        <button>
          <i
            className="fa-solid fa-arrow-left text-linecolor text-[30px] mr-14 mt-1"
            onClick={decrement}
          ></i>
        </button>
                  ...
                  <div className="w-[400px] h-[450px]">
                    <div className="border-2 bg-linecolor border-primaryBackground w-[340px] h-[405px] rounded-3xl text-center shadow-[30px_30px_0_0_rgba(0,0,0,0.2)] hover:w-[350px] hover:h-[415px] ">
                      ...
                      <div className="w-full mt-2 text-right">
                        <button
                          className="bg-secondaryText text-linecolor py-2 mx-3 rounded-[7px] w-40 hover:text-secondaryText hover:bg-linecolor hover:outline"
        ...
        <button>
          <i
            className="fa-solid fa-arrow-right text-linecolor text-[30px] mt-1"
            onClick={increment}
          ></i>
        </button>
      </div>
