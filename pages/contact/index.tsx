...
const Contact = () => {
  return (
    <div>
      ...
      <div className="mx-3 mb-10 md:mx-auto md:w-1/2 rounded-lg bg-slate-50 p-10">
        ...
        <div className="flex flex-col my-5">
          ...
          <div className="flex flex-row items-center">
            ...
            <div className=" font-bold  text-black mt-2 ml-3">Call / Whatsapp:</div>
            <div className="font-bold text-black ml-2">
              <a
          ...
          <div className="flex flex-row items-center">
            ...
            <div className=" font-bold text-black mt-2 ml-3">Github Username:</div>
            <div className="font-bold text-black ml-2">
              <a
                href="
          ...
          <div className="flex flex-row items-center">
            ...
            <div className=" font-bold text-black mt-2 ml-3">Linkedin Username:</div>
            <div className="font-bold text-black ml-2">
              <a
          ...
          <div className="flex flex-row items-center">
            ...
            <div className=" font-bold text-black mt-2 ml-3">
