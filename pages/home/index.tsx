...
const HomePage = () => {
  ...
  return (
    <div className="font-montserrat text-linecolor">
      ...
      <div>
        <Image
          className="w-full absolute z-0 h-[320px] md:h-[600px] lg:h-[700px] top-0 left-0"
          src={background}
          alt=""
        />
        <div className='absolute z-10 w-full flex justify-center'>
          <div className=" grid grid-cols-2  justify-center   ">
            <div className="w-full flex flex-col  mt-24 md:mt-56 px-10">
              <h1 className="text-2xl md:text-6xl lg:text-7xl font-bold">Full Stack</h1>
              <h1 className="w-3/4 text-3xl md:text-7xl lg:text-8xl  font-bold">
                Developer
              </h1>
              <h1 className="w-3/4 text-xs md:text-2xl lg:text-3xl mt-1 md:mt-5 font-bold">
            ...
            <div className="avatar  pt-12 md:pt-48 flex justify-center items-center">
              <div className="rounded-full w-[150px] h-[150px] md:w-[350px] md:h-[350px]">
      ...
      <div className="w-full h-[320px] md:h-[600px] lg:h-[700px]"></div>
