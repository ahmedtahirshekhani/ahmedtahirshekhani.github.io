...
const certifications: Certificate[] = [
  {
    ...
    platform: "NVIDIA",
    issued: "March 2022",
    credentialId: "1c852a396c60434eafff2e48e653fa14",
    skills: ["Deep Learning", "Machine Learning", "AI"],
    providerIcon: "logos:nvidia",
    platformIcon: "logos:nvidia",
    color: "from-green-500 to-teal-600",
    certificatePreview: "/certificates/nvidia-fundamentals-deep-learning.png",
    providerIconSize: 64,
    platformIconSize: 88,
  },
  {
    ...
    platform: "Cambridge English",
    issued: "Sep 2024",
    credentialId: "24PK501193SHEA363A",
    skills: ["English", "Communication"],
    providerIcon: "logos:cambridge",
    platformIcon: "logos:cambridge",
    color: "from-red-500 to-yellow-600",
    certificatePreview: "/certificates/ielts-7-5.png",
    providerIconSize: 64,
    platformIconSize: 88,
    platformLogo: "cambridge.png",
  },
  {
    ...
    platform: "LinkedIn",
    issued: "Jul 2023",
    credentialId: "cf993fbe25c870dbc0a5b8228461b62f9d5c67622f32cf0a11808596fcfd719a",
    skills: ["Content Creation", "English", "Interpersonal Skills"],
    providerIcon: "logos:linkedin",
    platformIcon: "logos:linkedin",
    color: "from-blue-500 to-purple-600",
    certificatePreview: "/certificates/how-to-talk-to-anyone.png",
    providerIconSize: 64,
    platformIconSize: 88,
  },
  {
    ...
    platform: "Google",
    issued: "2022",
    credentialId: "UC-672c82c6-7882-425c-ac59-061026e2aa22",
    skills: ["Google Ads", "Digital Marketing", "AdWords"],
    providerIcon: "logos:google",
    platformIcon: "logos:udemy",
    color: "from-orange-500 to-yellow-600",
    certificatePreview: "/certificates/google-ads-2022.png",
    providerIconSize: 64,
    platformIconSize: 88,
  },
];
                ...
                <div className="h-full bg-white/70 dark:bg-gray-900/50 backdrop-blur-sm rounded-2xl border border-gray-300 dark:border-gray-800 hover:border-gray-400 dark:hover:border-gray-600 transition-all duration-300 overflow-hidden">
                  ...
                  >
                    <div className="flex items-center justify-end mr-4 gap-1">
                      {cert.platformLogo ? (
                        <img
                          src={"logos/" + cert.platformLogo}
                          alt={cert.platform} // Add a descriptive alt text
                  ...
                  <div className="p-6 relative">
                    ...
                    {/* Credential ID */}
                    <div className="flex items-center justify-center pt-4 border-t border-gray-200/60 dark:border-gray-700/50">
                      <button
