...
const experience = [
  {
    ...
    type: "Full-time",
    companyIcon: "fa6-brands:uber",
    companyLogo:"careem_logo",
    companyColor: "from-green-500 to-green-600",
    description: "Designing and deploying Python-based microservices, integrating OpenAI, LangChain, and other AI-driven tools to create scalable, real-time solutions. Implementing predictive models, optimizing data pipelines, and improving dynamic pricing algorithms.",
    achievements: [
      "Designed and deployed a scalable AI/ML microservice architecture",
      "Built and integrated LLM-based solutions (ChatGPT, LangChain) into production systems",
      "Implemented a churn prediction model, improving retention by 20%",
      "Built a pseudonymization framework for secure data sharing"
    ],
    technologies: ["Python", "Node.js", "React", "OpenAI", "LangChain", "AWS", "MongoDB", "GraphQL", "Docker", "Kubernetes"]
  },
  {
    role: "Software Engineer",
    company: "Al-Nafi - E-Learning Platform",
    period: "Sept 2022 — Apr 2023",
    type: "Full-time",
    companyIcon: "mdi:school",
    companyLogo:"alnafi_logo",
    companyColor: "from-blue-500 to-blue-600",
    description: "Led the development of scalable e-learning platforms and tools. Built decentralized applications and enhanced platform performance using AWS services, leading to a more seamless experience for educators and students.",
    achievements: [
      "Spearheaded the development of scalable Learning Management Systems (LMS) and Content Management Systems (CMS)",
      "Developed and deployed decentralized applications (DApps) for blockchain-based learning solutions",
      "Improved the UI/UX, leading to a 40% increase in platform engagement",
      "Optimized cloud infrastructure for cost and performance, reducing operational overhead by 30%"
    ],
    technologies: ["React", "Node.js", "AWS", "Django", "PostgreSQL", "MongoDB", "Blockchain", "Docker", "Express"]
  },
  {
    ...
    type: "Internship",
    companyIcon: "devicon:angularjs",
    companyLogo:"10p_logo",
    companyColor: "from-gray-500 to-gray-600",
    description: "Contributed to the development of a responsive travel itinerary web application using Angular, Express.js, and MongoDB. Assisted in implementing Agile workflows and optimized CI/CD pipelines for faster deployment cycles.",
    achievements: [
      "Developed a travel itinerary web app using Angular 13 and Express.js",
      "Implemented test-driven development (TDD) with Jest to ensure frontend stability",
      "Streamlined development workflows by enhancing version control practices",
      "Collaborated on performance optimizations that improved app load time by 25%"
    ],
    technologies: ["Angular", "Express.js", "MongoDB", "Jest", "Docker", "CI/CD", "Git"]
  },
  {
    role: "Software Engineer Intern (Website Developer)",
    company: "Enzyme Digital - Marketing Agency",
    period: "Jun 2021 — Aug 2021",
    type: "Internship",
    companyIcon: "logos:react",
    companyLogo:"enzyme_logo",
    companyColor: "from-red-500 to-red-600",
    description: "Built and deployed high-performance, SEO-optimized web applications, including E-commerce and corporate platforms. Enhanced the internal tools with React, reducing redundant tasks and boosting team efficiency by 50%.",
    achievements: [
      "Delivered 90%+ Lighthouse scores for SEO-optimized web apps",
      "Integrated Facebook Pixel and Google Tag Manager to enhance conversion tracking",
      "Developed a custom React-based internal tool to optimize team workflows",
      "Achieved significant improvements in the agency's web performance and client satisfaction"
    ],
    technologies: ["React", "Next.js", "Node.js", "Google Analytics", "JavaScript", "Tailwind CSS", "SEO", "React"]
  }
];
            ...
            >
              <div className="flex flex-col sm:flex-row sm:items-start gap-6 md:gap-8 lg:gap-12">
                ...
                <div className="flex-shrink-0 flex flex-col items-center sm:items-start">
                  ...
                  >
                    <img
                      src={`logos/${exp.companyLogo}.png`}  // Update with the correct path to the logo images
                      alt={`${exp.company} logo`}
                      className="w-8 h-8 sm:w-9 sm:h-9 md:w-10 md:h-10 rounded-full object-contain relative z-10"
                    />
