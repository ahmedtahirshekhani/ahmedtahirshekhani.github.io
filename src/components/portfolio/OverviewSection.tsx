    ...
    >
      ...
      >
        ...
        <div className="grid lg:grid-cols-12 gap-6 md:gap-8 items-start px-4">
                ...
                <div className="space-y-4 md:space-y-6">
                  <div>
                    <h3 className="text-xl sm:text-2xl md:text-3xl font-bold mb-3 md:mb-4 text-gray-900 dark:text-white flex items-center gap-2 md:gap-3">
                      ...
                      Hello, I&apos;m Mr.Shekhani
                    </h3>
                    <p className="text-base md:text-lg lg:text-xl text-gray-600 dark:text-gray-300 leading-relaxed mb-4 md:mb-6">
                      A driven <span className="font-bold text-blue-600 dark:text-blue-400">Full Stack Developer</span> and 
                      <span className="font-bold text-purple-600 dark:text-purple-400">&nbsp;AI/ML Engineer</span> with 
                      <span className="font-bold text-green-600 dark:text-green-400">&nbsp;proven expertise</span> in building scalable, intelligent systems across
                      diverse industries. Passionate about leveraging 
                      <span className="font-bold text-yellow-600 dark:text-yellow-400">&nbsp;LLMs, real-time platforms, and cloud-native architectures</span> to deliver impactful digital solutions.
                    </p>
                  </div>
               ...
               {/* Expanded About Content */}
                <div className="space-y-3 md:space-y-4 border-t border-gray-200/50 dark:border-gray-700/50 pt-4 md:pt-6">
                  <p className="text-sm md:text-base text-gray-700 dark:text-gray-300 leading-relaxed">
                    I&apos;m a full-stack developer with a knack for turning coffee into code—and sometimes turning bugs into features (accidentally, of course!). I specialize in building scalable web and mobile apps using React, Next.js, TypeScript, and the magical art of cloud engineering. My superpower? Making complex problems disappear into sleek, AI-powered solutions that users actually love. 
                  </p>
                  <p className="text-sm md:text-base text-gray-700 dark:text-gray-300 leading-relaxed">
                    Outside of work, I&apos;m either deep into the latest AI craze, contributing to open-source projects, or mentoring the next wave of developers who will eventually tell their friends, &quot;I once got advice from a guy who built this.&quot; I&apos;m a firm believer in lifelong learning—because who wants to stop when the world of tech is evolving faster than my coffee consumption rate?
                  </p>
                </div>
                  ...
                  <div className="border-t border-gray-200/50 dark:border-gray-700/50 pt-4 md:pt-6">
                    ...
                    {["Machine Learning", "AI", "LangChain", "LLMs", "React", "Next.js", "TypeScript", "Python", "Node.js", "AWS", "Cloud Infrastructure", "SQL", "Docker", "Kubernetes"].map((skill, index) => (
                        <motion.span
                          key={skill}
                  ...
                  <div className="border-t border-gray-200/50 dark:border-gray-700/50 pt-4 md:pt-6">
                    ...
                    <div className="flex flex-wrap gap-2 md:gap-3">
                    {["Communication", "Teamwork", "Problem Solving", "Adaptability", "Leadership", "Critical Thinking", "Time Management", "English (Fluent)", "German (Intermediate)", "Urdu (Native)"].map((skill, index) => (
                        <motion.span
                          key={skill}
                          initial={{ opacity: 0, scale: 0 }}
                          animate={{ opacity: 1, scale: 1 }}
          ...
          {/* Enhanced Sidebar */}
          <motion.div variants={itemVariants} className="lg:col-span-5 space-y-6 mt-6 lg:mt-0">
            {/* Contact Card */}
            <div className="p-6 rounded-2xl bg-gradient-to-br from-purple-50/90 to-pink-50/90 dark:from-purple-950/30 dark:to-pink-950/30 backdrop-blur-sm border border-white/30 dark:border-gray-700/40 shadow-xl">
              ...
              <div className="space-y-3">
                ...
                >
                  ...
                  <div>
                    <div className="text-sm font-bold text-gray-900 dark:text-white break-all">ahmedtahir.developer@gmail.com</div>
                  </div>
                </motion.a>
                <motion.a
                  href="tel:+491786141157"
                  whileHover={{ scale: 1.02, x: 4 }}
                  whileTap={{ scale: 0.98 }}
                  className="flex items-center gap-3 p-3 rounded-lg bg-white/70 dark:bg-gray-800/30 hover:bg-white/90 dark:hover:bg-gray-800/50 transition-all duration-300 group border border-white/20 dark:border-gray-700/30"
                >
                  <div className="p-1 bg-gradient-to-r from-green-500 to-teal-500 rounded-md group-hover:from-green-600 group-hover:to-teal-600 transition-all shadow-md">
                    <Icon icon="solar:phone-bold" className="text-white w-4 h-4" width={16} height={16} />
                  </div>
                  <div>
                    <div className="text-sm font-bold text-gray-900 dark:text-white">+49 178 6141157 / +92 321 2575665</div>
                  </div>
                </motion.a>
                ...
                >
                  ...
                  <div>
                    <div className="text-sm font-bold text-gray-900 dark:text-white">ahmedtahir.me</div>
                  </div>
                </motion.div>
                ...
                >
                  ...
                  <div>
                    <div className="text-sm font-bold text-gray-900 dark:text-white">Frankfurt, Germany</div>
                  </div>
                </motion.div>
              </div>
            </div>
...
<div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 md:gap-6 mt-10">
  ...
  >
    <div className="flex items-start gap-3 md:gap-4 mb-3 md:mb-4">
      ...
      <div>
        <h4 className="font-bold text-gray-900 dark:text-white text-base md:text-lg">Software Engineer (AI/ML)</h4>
        <p className="text-blue-600 dark:text-blue-400 font-medium text-sm md:text-base">Careem (Uber Inc.)</p>
        <p className="text-xs md:text-sm text-gray-600 dark:text-gray-400 mt-1">May 2023 — Apr 2025</p>
      </div>
    </div>
    <p className="text-gray-700 dark:text-gray-300 text-xs md:text-sm leading-relaxed mb-2 md:mb-3 flex-1">
      Designing and deploying Python-based microservices, integrating OpenAI, LangChain, and AI-driven tools to build scalable solutions. Implementing predictive models, optimizing data pipelines, and driving dynamic pricing solutions.
    </p>
    <div className="flex items-center gap-2 text-xs md:text-sm mt-auto">
      ...
      <span className="font-semibold text-green-600 dark:text-green-400">AI/ML, Software Design, MLOps</span>
    </div>
  </motion.div>
  ...
  >
    <div className="flex items-start gap-3 md:gap-4 mb-3 md:mb-4">
      ...
      <div>
        ...
        <p className="text-green-600 dark:text-green-400 font-medium text-sm md:text-base">Al-Nafi - E-Learning Platform</p>
        <p className="text-xs md:text-sm text-gray-600 dark:text-gray-400 mt-1">Sept 2022 — Apr 2023</p>
      </div>
    </div>
    <p className="text-gray-700 dark:text-gray-300 text-xs md:text-sm leading-relaxed mb-2 md:mb-3 flex-1">
      Led development of scalable e-learning solutions using AWS, building decentralized applications, and improving platform performance. Spearheaded the deployment of scalable Learning Management Systems (LMS) and content management systems (CMS) for enhanced user experience.
    </p>
    <div className="flex items-center gap-2 text-xs md:text-sm mt-auto">
      <Icon icon="solar:shield-check-bold" className="text-blue-500 w-3 md:w-4 h-3 md:h-4" width={16} height={16} />
      <span className="font-semibold text-blue-600 dark:text-blue-400">E-Learning Systems Expert</span>
    </div>
  </motion.div>
  ...
  <motion.div
    variants={itemVariants}
    whileHover={{ scale: 1.02, y: -5 }}
    className="p-4 md:p-6 rounded-xl md:rounded-2xl bg-gradient-to-br from-purple-50/80 to-pink-50/50 dark:from-purple-950/30 dark:to-pink-950/20 backdrop-blur-sm border border-purple-200/50 dark:border-purple-800/30 shadow-xl flex flex-col"
  >
    <div className="flex items-start gap-3 md:gap-4 mb-3 md:mb-4">
      <div className="p-2 md:p-3 bg-purple-500 rounded-lg md:rounded-xl shadow-lg">
        <Icon icon="solar:code-square-bold" className="text-white w-5 md:w-6 h-5 md:h-6" width={24} height={24} />
      </div>
      <div>
        <h4 className="font-bold text-gray-900 dark:text-white text-base md:text-lg">Software Engineer Intern</h4>
        <p className="text-purple-600 dark:text-purple-400 font-medium text-sm md:text-base">10Pearls</p>
        <p className="text-xs md:text-sm text-gray-600 dark:text-gray-400 mt-1">Jun 2022 — Aug 2022</p>
      </div>
    </div>
    <p className="text-gray-700 dark:text-gray-300 text-xs md:text-sm leading-relaxed mb-2 md:mb-3 flex-1">
      Built responsive web apps with Angular, Express.js, and MongoDB. Contributed to code reviews and optimized CI/CD pipelines, improving deployment speed and stability.
    </p>
    <div className="flex items-center gap-2 text-xs md:text-sm mt-auto">
      <Icon icon="solar:star-bold" className="text-yellow-500 w-3 md:w-4 h-3 md:h-4" width={16} height={16} />
      <span className="font-semibold text-green-600 dark:text-green-400">Full Stack Developer Intern</span>
    </div>
  </motion.div>
</div>
      </motion.div>
...
<div className="max-w-4xl mx-auto mt-16">
    <SectionHeader
      tagText="Check out my work"
      tagIcon="solar:video-camera-bold"
      heading="Featured Video"
      description="Here’s a showcase of one of my projects. Take a look and see how I approach digital solutions."
      showUnderline={true}
      centered={true}
    />
    ...
    <motion.div
      ...
      viewport={{ once: true }}
    >
      <div className="w-full h-64 sm:h-80 md:h-96 lg:h-[500px] xl:h-[600px] rounded-xl overflow-hidden">
        <iframe
          width="100%"
          height="100%"
          src="https://www.youtube.com/embed/f1w9SYayQ68"
