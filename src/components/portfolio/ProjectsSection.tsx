...
const projects = [
  {
    title: "AKCRU - Multifarious Streaming Platform",
    subtitle: "Real-Time Video Streaming and Networking Platform",
    description: "A scalable real-time video streaming platform for meetings, messaging, and community interactions. Integrated meeting and community features with customizable video APIs for low-latency performance and real-time communication.",
    features: [
      "Real-time video streaming with low-latency performance",
      "Customizable user roles and session management",
      "Group video calls and individual streaming",
      "Chat and messaging features integrated",
      "Enhanced security with Castle.io and 2FA/OTP authentication",
      "Dynamic session management for different use cases",
      "Comprehensive user feedback and review system",
      "Scalable backend using Supabase and Firebase"
    ],
    deliverables: [
      "Fully functional real-time video streaming platform",
      "Customizable video APIs with 100ms latency",
      "User management system with dynamic roles",
      "Security enhancements including 2FA",
      "Mobile-responsive web interface for cross-device usage",
      "Advanced chat and messaging integration",
      "Scalable backend architecture using Firebase and Supabase",
      "Detailed analytics and performance tracking dashboards"
    ],
    tech: ["React Native", "Node.js", "Express.js", "Supabase", "Firebase", "100ms Video API", "Castle.io", "Tailwind CSS", "WebRTC", "JWT Authentication"],
    live: "https://akcru.com",
    gradient: "from-blue-500 to-cyan-500",
    status: "Live",
    category: "Web Application",
    highlight: "Featured",
    timeline: "12 months",
    clientType: "Streaming & Video Industry"
  },
  {
    title: "Autonomous Trading Bot",
    subtitle: "AI-Powered Stock Trading Bot",
    description: "An intelligent stock trading bot designed to automatically analyze market trends and make trades using machine learning algorithms. Integrated with real-time stock data and built for continuous learning to improve predictions over time.",
    features: [
      "Uses machine learning algorithms to analyze stock market trends",
      "Predicts stock price movements based on historical data",
      "Automatically executes trades based on market conditions",
      "Real-time stock data integration and analysis",
      "Dynamic risk management and portfolio optimization",
      "Modular architecture for future feature extensions",
      "Optimized performance for high-frequency trading scenarios"
    ],
    deliverables: [
      "AI-powered trading bot with real-time stock analysis",
      "Machine learning model for predicting stock price trends",
      "Modular trading system for automatic execution of trades",
      "Integrated with real-time market data for accuracy",
      "Performance-optimized for high-frequency trading scenarios",
      "Extensive backtesting system for trade strategy evaluation"
    ],
    tech: ["Python", "Flask", "Next.js", "TensorFlow", "Keras", "Scikit-learn", "MongoDB", "AWS Lambda", "Redis", "PostgreSQL"],
    github: "https://github.com/ahmedtahirshekhani/P03-AutonomousTradingBot",
  ...
  {
    title: "Shopify OneTag: AI-Powered Sales",
    subtitle: "AI Plugin for Shopify Stores",
    description: "A powerful AI plugin built for Shopify that automates the creation of product descriptions and optimizes them for SEO. Leveraging LLMs, the tool generates human-like text that improves product visibility and customer engagement.",
    features: [
      "Generates SEO-optimized product descriptions using LLMs",
      "Increases store visibility and engagement with automated content",
      "Seamless integration with Shopify for easy deployment",
      "Customizable content templates for different product categories",
      "Real-time product description generation based on input",
      "Analytics dashboard for performance tracking and content optimization"
    ],
    deliverables: [
      "AI-powered product description generator plugin for Shopify",
      "Integration with Shopify stores for automated deployment",
      "SEO-optimized content generation with LLMs",
      "Customizable templates for generating product descriptions",
      "Analytics dashboard for tracking SEO performance and improvements"
    ],
    tech: ["React", "Node.js", "OpenAI GPT", "Stripe","AWS", "Tailwind CSS"],
    live: "https://apps.shopify.com/onetag-ai?locale=cs",
